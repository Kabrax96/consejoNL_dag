/*
===========================================================================================================
Model Name          : t3__finanzas__egresos_etiquetados
Author              : Alejandro Morales Benavides
Date                : August 12th, 2025
Usage               : dbt build --select t3__finanzas__egresos_etiquetados

Objective           :
    This model:
        1) Filters detailed expenditures to Sections other than I (i.e., “etiquetados”).
...
Assumptions/Notes   :
    - Records include rows where SECCION <> 'I' and SECCION is not null.
...
-----------------------------------------------------------------------------------------------------------
Alejandro Morales Benavides   | 2025-08-12  | consejonl   | Created Tier 3 model for Section II and others (Egresos Etiquetados).
-----------------------------------------------------------------------------------------------------------
===========================================================================================================
*/
...
with base as (
  ...
  where seccion <> 'I' and seccion is not null
)
